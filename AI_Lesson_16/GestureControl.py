...
try:
    dev = AudioUtilities.GetOutputDevice() if hasattr(AudioUtilities, "GetDefaultOutputDevice") else AudioUtilities.GetSpeakers()
...
if not cap.isOpened(): print("Webcam not accessible"); exit()
